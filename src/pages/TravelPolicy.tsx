          ...
          <div className="space-y-6">
            ...
            <Section title="Local Travel">
              ...
              <SubSection title="In your home city">
                ...
                <div className="rounded-xl bg-esprint-pink/10 p-4 md:p-5 border border-esprint-pink/20 mt-3">
                  <div className="flex items-start gap-3">
                    <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-esprint-pink/20 text-esprint-pink shrink-0 mt-0.5">
                      <AlertTriangle className="h-5 w-5" />
                    </div>
                    <div className="space-y-2 text-esprint-darkblue/85 leading-relaxed">
                      <p className="font-semibold text-esprint-darkblue">
