      ...
      <div className="space-y-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <motion.div
            ...
            className="rounded-2xl border border-white/40 p-8 md:p-10 backdrop-blur-sm"
          >
            <p className="text-xs font-bold text-white/70 uppercase tracking-wide mb-4">Host</p>
            ...
            <h3 className="font-display font-bold text-xl text-white mb-3">Hasso Plattner Institute</h3>
          ...
          <motion.div
            ...
            className="rounded-2xl border border-white/40 p-8 md:p-10 backdrop-blur-sm"
          >
            <p className="text-xs font-bold text-white/70 uppercase tracking-wide mb-4">Organizer</p>
            <a href="https://hpi-engine.de" target="_blank" rel="noopener noreferrer">
              <img src={hpiEngineLogo} alt="HPI Engine" className="h-10 mb-6" />
            </a>
            <h3 className="font-display font-bold text-xl text-white mb-3">HPI Engine</h3>
            <p className="text-sm text-white/60 italic mb-2">Startup Ecosystem</p>
            <p className="text-white/80 text-sm leading-relaxed">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="rounded-2xl border border-white/40 p-8 backdrop-blur-sm flex flex-col md:flex-row items-center gap-8"
        >
          <a href="https://sap.com" target="_blank" rel="noopener noreferrer">
            <img src={sapLogoWhite} alt="SAP" className="h-16" />
          </a>
          <div>
            <p className="text-xs font-bold text-white/70 uppercase tracking-wide mb-1">Partner</p>
            <h3 className="font-display font-bold text-xl text-white">SAP</h3>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="rounded-2xl border border-white/40 p-8 md:p-12 backdrop-blur-sm text-center"
        >
          ...
          <p className="text-sm text-white/50 mt-4">
            ...
            <a href="/contact" className="text-white hover:underline font-semibold">Contact us!</a>
          </p>
        </motion.div>
      </div>
    </PageLayout>
